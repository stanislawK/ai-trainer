...
3. Write the eval dataset first: `evals/datasets/<sport>.extract.yaml` with at least 20 cases, covering ambiguous input, several activities in one message, a mixed-sport message and unusual units.
