...
1. **Cases first.** Add or extend cases in `evals/datasets/<template-id>.yaml` for the behaviour you want: expected outputs for code-graded checks, rubrics for `LLMJudge`.
