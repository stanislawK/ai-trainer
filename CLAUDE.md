...
M0 in progress: #2–#11 and #13–#15 are merged; #12, #16 and #17 are open. PRD 0002 (v0.3, design and installability) is Approved and supersedes PRD 0001. PRD 0003 (v0.4, sport inference and the sport glyph on replies) is Draft. Every ADR that M0 cites is Accepted (0001–0005, 0007–0009, 0012–0014, 0018, 0019); 0006, 0010, 0011 and 0015–0017 stay Proposed until their milestones. The Claude Design design system and screens exist ([docs/design/README.md](docs/design/README.md)). Next: ticket and build the M0 design foundation, then #16 and #17 on the new app shell, then #12.
