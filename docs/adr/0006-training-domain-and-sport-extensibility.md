...
| Status | Proposed |
| Date | 2026-09-16 |
| Related | PRD-0001 (G4, B1, B2, B5, B12), ADR-0003, ADR-0004, ADR-0008 |
...
**Grades:** stored as the original string, the scale and a canonical ordinal value. Case matters: "6A" is Fontainebleau (boulder), "6a" is French (sport).
